...
WallpaperEngine::Render::RenderContext& WallpaperApplication::getRenderContext () const { return *this->m_renderContext; }

void WallpaperApplication::setFrameCallback (std::function<void (WallpaperApplication&)> callback) {
    this->m_frameCallback = std::move (callback);
}
